...
public abstract class CreateBasePage extends BasePage {
    ...
    protected SelenideElement emptyBuildTypeNameMessage = $("#error_buildTypeName");
    protected SelenideElement createSuccessfulMessage = Selenide.$("#unprocessed_objectsCreated");
